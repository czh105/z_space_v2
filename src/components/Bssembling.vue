...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    let arr1 = [[-1.04, 0.2, -0.17, 0, 1.07, 0], [-1.12, 0.45, -0.14, 0, 1.27, 0], [-1.13, 0.58, 0.11, 0.02, 0.92, 0], [-1.05, 0.45, 0.40, 0.02, 0.72, -0.1], [-1.06, 0.28, 0.29, 0.02, 0.92, 0]]
    ...
    watch(topicNum, () => {
      ...
      if (topicNum.value === 0) {
        ...
        cpu3.visible = false
        cpu2.visible = true
        startFree([0, 0, 0, 0, 0, 0], { x: -72.40, y: 66.14, z: 38.98 }, { x: -19.61, y: 28.61, z: 18.53 })
      }
      if (topicNum.value === 1) {
      ...
      if (topicNum.value === 11) {
        ...
        chengpin.visible = true
        chengpin2.visible = false
        startFree([-1.12, 0.45, -0.14, 0, 1.27, 0], { x: -50.72, y: 48.58, z: 38.16 }, { x: -17.19, y: 23.05, z: 2.33 })
      }
      if (topicNum.value === 12) {
        if (bigType !== "教学演示") return;
        home.visible = true;
      ...
      if (topicNum.value === 38) {
        ...
        chengpin.visible = true
        chengpin2.visible = false
        startFree([0, 0, 0, 0, 0, 0], { x: -26.32, y: 28.22, z: -18.77 }, { x: -32.24, y: 19.28, z: 3.09 })
      }
      ...
      if (topicNum.value === 39) {
        ...
        chengpin.visible = true
        chengpin2.visible = false
        startFree([-1.72, -0.16, 0.21, 0, 1.27, 0], { x: -36.13, y: 43.23, z: -38.29 }, { x: -15.91, y: 12.46, z: 23.00 })
      }
      if (topicNum.value === 40) {
        if (bigType !== "教学演示") return;
        home.visible = true;
    ...
    <div class="left_box" v-if="showlr">
      ...
      <div class="robot_opt" :style="topicOneImg" v-if="leftContent === '装配调试实训任务'">
        ...
        <div class="codepage" v-if="topicNum === 5">
          ...
          <div class="conBtn" style="width: 69px; height: 32px; left: 217px; top: 289px" @click="topicNum++"></div>
        </div>
        ...
        <div class="codepage" v-if="topicNum === 6">
          ...
          <div class="conBtn" style="width: 69px; height: 32px; left: 217px; top: 289px" @click="topicNum = 7"></div>
        </div>
        ...
        <div class="codepage" v-if="topicNum === 18">
          ...
          <div class="conBtn" style="width: 69px; height: 32px; left: 218px; top: 292px" @click="topicNum++"></div>
        </div>
        ...
        <div class="codepage" v-if="topicNum === 19">
          ...
          <div class="conBtn" style="width: 69px; height: 32px; left: 217px; top: 289px" @click="topicNum = 20"></div>
        </div>
        <div class="conBtn" style="
            width: 40px;
            height: 36px;
        ...
        <div class="codepage" v-if="topicNum === 35">
          ...
          <div class="conBtn" style="width: 69px; height: 32px; left: 217px; top: 289px" @click="topicNum = 36"></div>
        </div>
        <div class="conBtn" style="
            width: 40px;
            height: 36px;
        ...
        <div class="codepage" v-if="topicNum === 47">
          ...
          <div class="conBtn" style="width: 69px; height: 32px; left: 217px; top: 289px" @click="topicNum = 48"></div>
        </div>
        <div class="conBtn" style="
            width: 40px;
            height: 36px;
