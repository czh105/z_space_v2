...
function upDown(type: string) {
    ...
    watch(topicNum, () => {
      ...
      if (topicNum.value === 15) {
        ...
        startFree(
          [-0.28, 0.49, -0.05, 0, 1.07, 0],
          { x: 10.52, y: 30.05, z: 29.61 },
          { x: 23.18, y: 15.0, z: 14.91 },
          () => {
            showtips.value = true;
          }
        );
...
<template>
  <div class="controls_box">
    ...
    <div
      class="lipsBtn"
      v-if="topicNum === 12.1"
      @click="(topicNum = 13), (showlr = false)"
    >
      下一步
    </div>
    ...
    <div
      class="lipsBtn"
      v-if="topicNum === 14.1"
      @click="(topicNum = 15), (showlr = false)"
    >
      下一步
    </div>
    ...
    <div class="left_box" v-if="showlr">
      ...
      >
        ...
        <div class="codepage" v-if="topicNum === 5">
          <div
            class="conBtn"
            style="width: 58px; height: 14px; left: 48px; top: 92px"
          >
            <thinking-select
              :list="[
                { label: 'MoveJ', value: 1 },
          ...
          <div
            class="conBtn"
            style="width: 58px; height: 14px; left: 48px; top: 140px"
          >
            <thinking-select
              :list="[
                { label: 'MoveJ', value: 0 },
          ...
          <div
            class="conBtn"
            style="width: 40px; height: 14px; left: 48px; top: 177px"
          >
            <thinking-select
              :list="[
                { label: 'Set', value: 1 },
        ...
        <div class="codepage" v-if="topicNum === 6">
          <div
            class="conBtn"
            style="width: 58px; height: 14px; left: 49px; top: 92px"
          >
          ...
          <div
            class="conBtn"
            style="width: 86px; height: 14px; left: 151px; top: 142px"
          >
            <!-- <input v-model="resultForm.a.a1" /> -->
            <thinking-select
              :list="[
          ...
          <div
            class="conBtn"
            style="width: 58px; height: 14px; left: 49px; top: 142px"
          >
            <!-- <input v-model="resultForm.a.a1" /> -->
            <thinking-select
              :list="[
        ...
        <div
          class="nextb"
          v-if="topicNum === 10.5"
          @click="(topicNum = 11), (showlr = false)"
        >
          下一步
        </div>
        ...
        <div class="codepage" v-if="topicNum === 12">
          ...
          <div
            class="t1-1-9"
            @click="(topicNum = 12.1), (showlr = false)"
          ></div>
        </div>
        ...
        <div class="codepage" v-if="topicNum === 14">
          ...
          <div
            class="t1-1-9"
            @click="(topicNum = 14.1), (showlr = false)"
          ></div>
        </div>
      </div>
    </div>
