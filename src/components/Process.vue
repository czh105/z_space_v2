...
function upDown(type: string) {
    ...
    let arr1 = [[-1.04, 0.2, -0.17, 0, 1.07, 0], [-1.33, 0.25, 0.06, 0, 1.26, 0], [-1.34, 0.50, 0.27, 0, 0.84, 0]]
    let arr2 = [[-1.04, 0.2, -0.17, 0, 1.07, 0], [-1.23, 0.25, 0.06, 0, 1.26, 0], [-1.23, 0.53, 0.21, 0, 0.82, 0]]
    let arr3 = [[1.23, -0.04, 0, 0, 1.56, 0], [1.15, 0.36, 0.56, 0.44, -1.23, 0.32]]
    let arr4 = [[1.23, -0.04, 0, 0, 1.56, 0], [1.15, 0.36, 0.56, 0.44, -1.23, 0.32], [1.25, 0.33, 0.55, 0.24, -1.10, 1.02], [1.25, 0.33, 0.55, 0.36, -1.10, 1.82], [1.21, 0.28, 0.47, 0.43, -1.15, 0.20], [1.10, 0.34, 0.47, 0.57, -1.10, -1.30], [1.08, 0.34, 0.47, 0.57, -1.10, -1.91]]
    ...
    watch(topicNum, () => {
      ...
      if (topicNum.value === 0) {
        ...
        startFree(
          [0, 0, 0, 0, 0, 0],
          { x: -52.68, y: 70.16, z: 63.79 },
          { x: 0.99, y: 15.97, z: 11.57 }
        );
      }
      // 焊枪
      if (topicNum.value === 1) {
