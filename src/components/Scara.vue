  ...
  <div class="controls_box">
    ...
    <div class="left_box" v-if="showlr">
      ...
      <div class="robot_opt" :style="topicOneImg">
        ...
        <div class="runBtn" v-if="topicNum === 5" @click="topicNum++, (showlr = false), (showHelp = true)"></div>
        ...
        <div class="runBtn" v-if="topicNum === 10" @click="topicNum++, (showlr = false), (showHelp = true)"></div>
        ...
        <div class="runBtn" v-if="topicNum === 15" @click="topicNum++, (showlr = false), (showHelp = true)"></div>
        ...
        <div class="runBtn" v-if="topicNum === 20" @click="topicNum++, (showlr = false), (showHelp = true)"></div>
