  ...
  <div class="controls_box">
    ...
    <div class="touchpage" v-if="topicNum === 1">
      <div class="screen" style="left: 80px; top: 78px">
        ...
        <div class="ld" style="left: 320px; top: 10px; background-color: rgb(247, 75, 75)" @click="switchAll('转台夹紧')">
          夹紧
        </div>
        <div class="ld" style="left: 370px; top: 10px; background-color: rgb(75, 247, 104)" @click="switchAll('转台松开')">
          松开
        </div>
        <div class="ld" style="left: 320px; top: 50px; background-color: rgb(247, 75, 75)" @click="switchAll('转台顺时针')">
          顺时针
        </div>
        <div class="ld" style="left: 370px; top: 50px; background-color: rgb(75, 247, 104)" @click="switchAll('转台逆时针')">
          逆时针
        </div>
        <div class="name" style="top: 100px; left: 240px">工台</div>
        <div class="ld" style="left: 320px; top: 100px; background-color: rgb(247, 75, 75)" @click="switchAll('工台夹紧')">
          夹紧
        </div>
        <div class="ld" style="left: 370px; top: 100px; background-color: rgb(75, 247, 104)" @click="switchAll('工台松开')">
          松开
        </div>
        <div class="name" style="top: 184px; left: 240px">转位</div>
        <div class="ld" style="left: 320px; top: 150px; background-color: rgb(247, 75, 75)" @click="switchAll('转位上升')">
          上升
        </div>
        <div class="ld" style="left: 370px; top: 150px; background-color: rgb(75, 247, 104)" @click="switchAll('转位下降')">
          下降
        </div>
        <div class="ld" style="left: 320px; top: 185px; background-color: rgb(247, 75, 75)" @click="switchAll('转位顺时针')">
          顺时针
        </div>
        ...
        <div class="ld" style="left: 320px; top: 218px; background-color: rgb(247, 75, 75)" @click="switchAll('转位夹紧')">
          夹紧
        </div>
        <div class="ld" style="left: 370px; top: 218px; background-color: rgb(75, 247, 104)" @click="switchAll('转位松开')">
          松开
        </div>
      </div>
    ...
    <div class="left_box" v-if="showlr">
      ...
      <div class="robot_opt" :style="topicOneImg" v-if="leftContent === '打磨单元调试实训任务'">
        ...
        <div class="codepage" v-if="topicNum === 7">
          ...
          <div class="conBtn" style="width: 90px; height: 34px; left: 200px; top: 292px" @click="topicNum++"></div>
        </div>
        ...
        <div class="codepage" v-if="topicNum === 8">
          ...
          <div class="conBtn" style="width: 90px; height: 34px; left: 200px; top: 292px" @click="topicNum = 10"></div>
        </div>
        ...
        <div class="codepage" v-if="topicNum === 16">
          ...
          <div class="conBtn" style="width: 90px; height: 34px; left: 200px; top: 292px" @click="topicNum = 18"></div>
        </div>
